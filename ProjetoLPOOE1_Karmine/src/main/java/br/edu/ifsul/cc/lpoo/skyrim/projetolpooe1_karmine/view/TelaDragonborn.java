        ...
        if (dragonbornSelecionado != null) {
            ...
            if (confirmacao == JOptionPane.YES_OPTION) {
                try {
                    ...
                    List<Dragonborn> dragonbornList = jpa.getDragonborn();
                    for (Dragonborn d : dragonbornList) {
                        if (d.getNome().equals(dragonbornSelecionado)) {
                            // Desassocia o Companion, se houver
                            Companion companion = d.getCompanion();
                            if (companion != null) {
                                companion.setDragonborn(null);
                                jpa.atualizar(companion); 
                            }
                            jpa.remover(d);
                            break;
                        }
